...
def create_file(number_sheet):
    # create workbook
    wb = Workbook()
    path_report = os.path.join('E:\SecurityBox_Project\APreport', 'report_1.xlsx')
    wb.save(path_report)
    # Copy template for report
    path_template = os.path.join('E:\SecurityBox_Project\APreport', 'template.xlsx')
...
def modify_file(data):
    # file path
    filepath = os.path.join('E:\SecurityBox_Project\APreport', 'Expenses03.xlsx')
    ...
    sheet['D10'] = sheet['D11'] + sheet['D12']
    sheet['E10'] = data['a_i_2_note']
    sheet['D14'] = data['a_i_2_3_amount']
    sheet['E14'] = data['a_i_2_3_note']
    sheet['D15'] = data['a_i_2_4_amount']
    sheet['D15'] = data['a_i_2_4_note']
    sheet['D13'] = sheet['D14'] + sheet['D15']
    sheet['D8'] = sheet['D10'] + sheet['D13']
    ...
    sheet['D25'] = data['a_ii_2_5_note']
    sheet['D20'] = sheet['D22'] + sheet['D23'] + sheet['D24'] + sheet['D25'] + sheet['D26']
    ...
    sheet['D31'] = sheet['D33'] + sheet['D34'] + sheet['D35']
    ...
    sheet['D36'] = sheet['D38'] + sheet['D39'] + sheet['D40']
    ...
    sheet['D58'] = sheet['D60'] + sheet['D61'] + sheet['D62']
    ...
    sheet['D75'] = sheet['D77'] + sheet['D78'] + sheet['D79']
    ...
    sheet['D87'] = sheet['D89'] + sheet['D90'] + sheet['D91']
    sheet['E78'] = data['c_ii_2_note']
    ...
    sheet['D123'] = sheet['D124'] + sheet['D125'] + sheet['D126'] + sheet['D127']
    ...
    sheet['D128'] = sheet['D129'] + sheet['D130'] + sheet['D131'] + sheet['D132']
    ...
    sheet['D134'] = sheet['D135'] + sheet['D136'] + sheet['D137']
    ...
    sheet['D138'] = sheet['D139'] + sheet['D140'] + sheet['D141']
